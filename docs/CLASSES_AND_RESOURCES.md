...
>
> **Issue:** References `class_resources` / `class_resource_assignments`. DB has `studio_resources` / `studio_resource_assignments`.
>
> **Canonical replacement:** docs/CLASSES.md (with corrected table names)
>
