> 📍 **Portal & Route Surface Map**
>
> This document maps the platform by **route and UI surface** — the 
> 12 places a user navigates to (Parent Portal, Teacher Portal, Admin 
> Dashboard, SEO Engine, etc.).
>
> This is NOT the capability module list (M1–M13). For the capability 
> taxonomy that organizes the platform by domain (Communications, 
> Scheduling, Teachers, etc.), see:
>
> - `docs/strategy/platform-product-requirements.md` (canonical)
> - `/CLAUDE.md` Section 7 (summary)
>
> Both views are legitimate. They describe the same platform from 
> different angles.

---

# BAM Platform — Portal & Route Surface Map
