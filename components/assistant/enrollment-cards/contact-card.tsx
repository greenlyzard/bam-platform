...
export function ContactCard({ config, onComplete }: ContactCardProps) {
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        ...
        <label className="flex items-start gap-2 text-xs text-mist">
          ...
          <span>
            ...
            studio at the number provided. Message and data rates may apply.
            Reply STOP to cancel. Reply HELP for help. Message frequency varies.
          </span>
        </label>
        ...
        <div>
          ...
          <select
            ...
            className="appearance-none bg-white border border-silver rounded-md px-3 py-1.5 text-sm text-charcoal focus:outline-none focus:ring-2 focus:ring-opacity-20 cursor-pointer w-full"
          >
