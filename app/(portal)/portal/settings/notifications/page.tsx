...
const TYPES = [
  { key: "private_scheduled", label: "Private lesson scheduled" },
  { key: "private_confirmed", label: "Private lesson confirmed" },
  { key: "class_reminder", label: "Class reminder (24h before)" },
  { key: "evaluation_published", label: "Evaluation published" },
  { key: "announcement", label: "Studio announcements" },
  { key: "channel_message", label: "New message in a channel" },
  { key: "direct_message", label: "New direct message" },
  { key: "billing_alert", label: "Billing & payment alerts" },
  { key: "performance_update", label: "Performance & rehearsal updates" },
  { key: "trial_followup", label: "Trial class follow-up" },
];
...
const DEFAULT_ON: Record<string, Channel[]> = {
  ...
  billing_alert: ["in_app", "email", "push"],
  performance_update: ["in_app", "push"],
  trial_followup: ["in_app", "push"],
};
