...
// ── Location actions ─────────────────────────────────────
// Removed 2026-07-09 (LOCATIONS_AND_FACILITIES §5.1). Locations are edited only via
// app/(admin)/admin/settings/studio/actions.ts (the sole writer of studio_locations).
// This surface manages studio_resources only.
