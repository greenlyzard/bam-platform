    ...
    Tables: {
      ...
      invoice_line_items: {
        Row: {
          ...
          bundle_entitlement_id: string | null
          class_id: string | null
          costume_fee_id: string | null
          created_at: string
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "invoice_line_items_dance_id_fkey"
            columns: ["dance_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "invoice_line_items_pricing_rule_id_fkey"
            columns: ["pricing_rule_id"]
            isOneToOne: false
            referencedRelation: "class_pricing_rules"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "invoice_line_items_private_session_id_fkey"
            columns: ["private_session_id"]
            isOneToOne: false
      ...
      payment_allocations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "payment_allocations_invoice_line_item_id_fkey"
      ...
      refunds: {
        Row: {
          ...
          id: string
          payment_id: string
          processor_refund_ref: string | null
          reason: string
          status: string
          tenant_id: string
          updated_at: string
